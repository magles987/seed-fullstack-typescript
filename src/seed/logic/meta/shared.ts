...
/**adición de interfaz genérica con propiedades
 * comunes para el diccionario de instancias
 * según el contexto lógico
 */
export interface IDiccCommonModuleInstance {
  /**listado de instancias de drivers disponibles para usar en en contexto lógico */
  driversList: [Driver, ...Driver[]]; //tipado de array especial que indica NO se permite inicializar con vacíos
}
...
> extends IDiccCommonModuleInstance,
    IPrimitiveMutateContext<TPrimitiveFormatInstance>,
...
/**esquema de instancias de módulos (de acción como de cursor) */
