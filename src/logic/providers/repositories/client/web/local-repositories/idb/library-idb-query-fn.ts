...
export class GenericLibraryIdbQueryFn<
  TModelOrValue
> extends GenericLibraryLocalRepositoryQueryFn<TModelOrValue, IdbRepository> {
...
export class PrimitiveLibraryIdbQueryFn<
  TValue
> extends PrimitiveLibraryLocalRepositoryQueryFn<TValue, IdbRepository> {
  /**  Almacena la instancia única de esta clase */
...
export class StructureLibraryIdbQueryFn<
  TModel
> extends StructureLibraryLocalRepositoryQueryFn<TModel, IdbRepository> {
  /**  Almacena la instancia única de esta clase */
