...
import {
  TGenericLocalStorageCustomQueryRepositoryFn,
  TPrimitiveLocalStorageCustomQueryRepositoryFn,
  TStorageType,
  TStructureLocalStorageCustomQueryRepositoryFn,
} from "./shared-types";
import {
...
export class StorageRepository
  ...
  implements ReturnType<StorageRepository["getDefault"]>
{
   ...
   */
  constructor(
    base: Partial<ReturnType<StorageRepository["getDefault"]>> = {},
    isInit = true
  ) {
    super(base, false);
  ...
  protected override getDefault() {
    return StorageRepository.getDefault();
  }
  protected override getCONST() {
    return StorageRepository.getCONSTANTS();
  }
  ...
  //  */
  // protected override initProps(base: Partial<ReturnType<StorageRepository["getDefault"]>>): void {
  ...
  //  */
  // public override resetPropByKey(key: keyof ReturnType<StorageRepository["getDefault"]>): void {
  ...
  public override getLiteral(): ReturnType<StorageRepository["getDefault"]> {
  ...
  >(): TCustomLibrary {
    return StorageRepository.primitiveLibraryQueryFn as TCustomLibrary;
  }
  ...
  >(v: TCustomLibrary): void {
    ...
    StorageRepository.primitiveLibraryQueryFn = v;
  }
  /**obtienen la librería de funciones de consultas
   *
  ...
  >(): TCustomLibrary {
    return StorageRepository.structureLibraryQueryFn as TCustomLibrary;
  }
  /**asignar librería totalmente personalizada a la propiedad
   * que almacena dicha librería */
  ...
  >(v: TCustomLibrary): void {
    const util = TwinBeeModule.util;
    if (!util.isInstance(v)) return;
    StorageRepository.structureLibraryQueryFn = v;
  }
  /**
   * descrip...
   * ____
  ...
  public async emptyAllStorage(
    ...
    await StorageRepository.emptyAllStorage(keyScope);
    return;
  }
  /**... */
  ...
  protected override async readByLiteralCriteria(
    ...
    if (this.util.isFunction(customQueryRepositoryFn)) {
      //personalizada
      const fn =
        customQueryRepositoryFn as TGenericLocalStorageCustomQueryRepositoryFn<any>;
  ...
  protected override async primitiveReadByLiteralCriteriaModule(
    ...
    if (this.util.isFunction(customQueryRepositoryFn)) {
      //personalización
      const fn =
        customQueryRepositoryFn as TPrimitiveLocalStorageCustomQueryRepositoryFn<any>;
      registers = await fn(this, literalCriteria, registers);
    } else {
      //estándar
    }
  ...
  protected override async structureReadByLiteralCriteriaModule(
    ...
    if (this.util.isFunction(customQueryRepositoryFn)) {
      //personalizada
      const fn =
        customQueryRepositoryFn as TStructureLocalStorageCustomQueryRepositoryFn<any>;
      registers = await fn(this, literalCriteria, registers);
    } else {
      //estándar
    }
