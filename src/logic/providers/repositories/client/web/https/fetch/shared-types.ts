 ...
 * personalizada de este Repository (este tipo será inyectado a)*/
...
/** */
export type TTFetchRepositoryBaseConfig = [
  string,
  Partial<ReturnType<FetchRepository["getDefault"]>>? //debe ser opcional
];
